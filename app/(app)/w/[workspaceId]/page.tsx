...
export default async function WorkspaceHome({ params }: { params: Promise<{ workspaceId: string }> }) {
  ...
  return <><PageHeader title={`좋은 하루예요, ${user?.displayName}님`} description="AI 스터디 · 매주 논문 한 편을 함께 읽고 정리합니다." /><main className="min-h-0 flex-1 overflow-y-auto p-6"><div className="mx-auto max-w-5xl space-y-8">
